...
public class Agendar implements  botones_agenda{
    String SQL_INSERT = "INSERT INTO dato(cedula, paciente, eps, direccion, especialidad, sexo, observaciones) VALUES(?,?,?,?,?,?,?)";
    ...
    public List<agenda> Mostrar_Agendar(agenda agendar)
    {
        ...
        try{
            ...
            while (rs.next()){
                ...
                String DireccionAgendar = rs.getString("direccion");
                String EspAgendar = rs.getString("especialidad");
                String SexoAgendar = rs.getString("sexo");
                String ObsAgendar = rs.getString("observaciones");
                String FechaAgendar = rs.getString("fecha cita");
                String EstadoAgendar = rs.getString("estado");

                Agendar1 = new agenda(CedulaAgendar, PacienteAgendar, EPSAgendar, DireccionAgendar, EspAgendar, SexoAgendar, ObsAgendar, FechaAgendar, EstadoAgendar);
